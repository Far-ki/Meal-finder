            ...
            <div className='bg-white p-3 rounded w-25'>
                ...
                <form action="" onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        ...
                        <input type="text" placeholder='Wprowadź imie' name='name'
                    ...
                    <button type='submit' className='btn btn-success w-100 rounded-0'><strong>Zarejestruj</strong></button>
                    <p>Zgodna na przetwarzanie danych</p>
                    <Link to="/" className='btn btn-default border w-100 rounded-0 text-decoration-none'>Zaloguj</Link>
