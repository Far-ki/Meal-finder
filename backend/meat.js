            ...
            for (let i = 0; i < recipes.length; i++) {
                ...
                try {
                    ...
                    if (recipeUrl !== undefined) {
                        ...
                        await axios.post('http://localhost:8081/meat', { recipeTitle, ingredients, recipeUrl, recipeImage, difficulty, cook_time });
...
const mainPageUrl = 'https://gotujmy.pl/przepisy-dania-miesne.html';
